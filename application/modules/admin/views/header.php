  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?php echo base_url().'admin'; ?>" class="logo"><b>Careers Scaledesk </b></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li  class="sub-menu">
                      ...
                      <ul class="sub">
                          <li  <?php  if($active==2){ ?> class="active"<?php }?>><a   href="<?php echo  base_url().'admin/jobs'; ?>">Post Jobs</a></li>
                          <li <?php  if($active==3){ ?> class="active"<?php }?> ><a    href="<?php echo  base_url().'admin/getJobPost'; ?>">Jobs Details</a></li>
